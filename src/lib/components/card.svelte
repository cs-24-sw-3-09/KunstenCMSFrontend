...
<div class="dashboard-card">
    <div class="dashboard-card-top">
        <div class="dashboard-card-preview">
            <img src={device.content !== "" ? device.content : fallback} alt=""/> <!-- TODO: add dynamic html element for video-->
        </div>
    </div>
    <div class="dashboard-card-bottom">
        ...
        <div class="dashboard-card-slideshow-info">
            ...
            <div class="dashboard-card-slideshow-title">{device.slideshow}</div>
        </div>
